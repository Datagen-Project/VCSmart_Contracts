...
contract("AngTry", accounts => {
    ...
    describe("#DG Release", function() {
        ...
        it("has to transfer all the #DG", async function() {
            ...
            finalBalanceOf4.toString().should.equal("100000000000000000000");
        });
    ...
    describe("change VcWallet", async function() {
        ...
        it.only("has to transfer first release on a wallet than to another one", async function() {
            time.increaseTo("1655906400");
            ...
            checkString.should.equal("41666666666666666664166666666666666667");
        });
    }); 
});